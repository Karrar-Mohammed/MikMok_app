...
//        VideoPlayer("Life is hard but beautiful","It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less","https://android-tv-classics.firebaseapp.com/content/buffalo_dance/media_buffalo_dance.mp4"),
